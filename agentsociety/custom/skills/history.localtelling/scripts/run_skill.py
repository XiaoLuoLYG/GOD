...
SKILL_ID = 'history.localtelling'
SUMMARY = 'Tell local history to connect present action with memory.'
TARGET_LOCATIONS = ['library', 'park']
TARGET_INTERACTIONS = ['research_topic', 'meet_friend']
STATUS = 'storytelling'
EMOTION = 'warm'
SPEECH = '我想用一个本地故事帮大家理解这件事。'
MEMORY_TEMPLATE = 'Used history.localtelling: {summary} at {location_id}.'
