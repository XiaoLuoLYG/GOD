(function () {
  ...
  var STATIC_TEXT = {
    en: {
      ...
      "home.acceptanceEyebrow": "🎉 EMNLP 2026 · System Demonstrations",
      "home.acceptanceTitle": "GOD accepted at EMNLP 2026.",
      "home.acceptanceSummary": "Read the camera-ready paper by Yige Luo and Ran Guan.",
      "home.paperCta": "Read the paper (PDF) ↗",
    ...
    zh: {
      ...
      "home.acceptanceEyebrow": "🎉 EMNLP 2026 · 系统演示",
      "home.acceptanceTitle": "GOD 已被 EMNLP 2026 录用。",
      "home.acceptanceSummary": "阅读 Yige Luo 与 Ran Guan 的 Camera-ready 论文。",
      "home.paperCta": "阅读论文（PDF）↗",
